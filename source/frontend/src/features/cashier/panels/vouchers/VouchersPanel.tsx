...
function VouchersPanel({ permissions = [] }: VouchersPanelProps) {
    ...
    const handleSubmit = async () => {
        try {
            await apiService.saveVoucher(editing ? editing.code : null, {
                code: formData.code,
                type: formData.type,
