...
function ProductsPanel({ permissions = [] }: ProductsPanelProps) {
    ...
    const [categories] = useState<Category[]>(mockService.getCategories());
    ...
    const reload = () => setProducts(mockService.getProducts());
                        ...
                        <div className="admin-modal-body">
                            ...
                            <div className="form-group">
                                ...
                                <div className="image-preview-area" style={{
                                    border: '2px dashed var(--color-border-light)', borderRadius: '12px',
                                    ...
                                    {(imagePreview || formData.image) ? (
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                                            <Coffee size={32} />
                                            <p>Image upload will be available when connected to the backend</p>
                                        </div>
                                    )}
                                </div>
                            </div>
